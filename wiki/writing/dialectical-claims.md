...
aliases: ["Dialectical.Claims", "Dialectical Claims"]
related:
...
Inspired by the principles of [anti-debate](https://www.anti-debate.org/about.html), the system is designed not for intellectual combat but for structured inquiry. It avoids the trap of shallow disagreement by forcing each position to encounter the **strongest possible version of its opposition**, an approach inspired by Stephanie Lepp's exploration of [anti-debate](https://www.anti-debate.org/references.html) and her integrative media project, *[Faces of X](https://www.ted.com/talks/bill_heck_and_stephanie_lepp_why_meeting_in_the_middle_isn_t_enough_for_today_s_trickiest_debates)*. Instead of seeking flaws, each agent must find the generative potential in the other's position. The goal is not to declare a winner but to see what emerges from the tension. The real-time streaming AI dialogue transforms philosophy from textual archaeology into live intellectual dance, allowing you to witness arguments developing and syntheses emerging as each round spirals deeper into the contradictions while seeking genuine synthesis.
...
These aren't questions that [Dialectical.Claims](http://www.dialectical.claims) answers. It succeeds insofar as it reveals something about the nature of thinking itself and the conditions under which ideas develop or stagnate.
...
Dialectical.Claims is available at [dialectical.claims](http://www.dialectical.claims).

The source code is [open](https://github.com/omniharmonic/dialecticalclaims).
