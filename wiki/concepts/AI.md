...
Artificial intelligence, in Benjamin Life's work, is a bifurcated force that operates simultaneously as capitalism's most powerful accelerant and as the potential catalyst for collective liberation. His treatment is neither techno-utopian nor doomer but dialectical: the same capabilities that drive marginal costs toward zero and democratize productive capacity can also, when concentrated in few hands, enable total surveillance and techno-feudalism. AI is therefore understood less as a fixed technology than as a hinge between two divergent futures.
...
This bifurcated reading of AI is developed most fully in [[how-and-why-ai-will-accelerate-capitalism-and-then-destroy-it]], with its liberatory, build-it-yourself dimension explored in [[civic-vibe-coding-localism]] and its surveillance defenses in [[ai-surveillance-endgame-zero-knowledge-identity]].
