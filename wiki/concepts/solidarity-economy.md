...
A **solidarity economy** is an economic order organized around mutual benefit rather than extraction, in which value creation, value circulation, and value governance are re-embedded in real, accountable, reciprocal relationships. Where capitalism reinforces accumulation through winner-take-all, zero-sum dynamics, the solidarity economy reinforces shared prosperity through positive-sum coordination. It is not charity or redistribution layered atop a market, but a parallel system with its own structural logic and compounding momentum.

## Re-embedding the Economy

Karl Polanyi diagnosed capitalism's tendency to "disembed" economic activity from social life — to treat labor, land, and money as commodities when they are nothing of the kind. The solidarity economy is the operational answer to that disembedding. It rests on a recognition almost embarrassing in its simplicity: **value is relational**. Genuine wealth emerges in the space between people — between a community and its watershed, between a worker and the meaning they find in their labor — not in the price at which an asset can be liquidated.

This makes the solidarity economy a structural inversion of extractive capitalism rather than a reform of it. Reform is too easily captured; the orientation itself must change.

## Structural Mechanisms

The solidarity economy is not a sentiment but an architecture. Its building blocks include:
